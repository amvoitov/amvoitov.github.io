...
- **RFID и режим «Свой-Чужой» (зконтроль и отслеживание несанкционированной выгрузки):**
...
## Сайт (личный кабинет + админка + общие требования из ТЗ «Сайт…»)
...
- **Главная страница: календарь + карта**
    - Слева календарь (день/период), справа карта с БП, работавшими в выбранные даты; по БП — просмотр транзакций по датам. 
- **Поля:**
    - Добавление полей ручной обводкой контура на карте,
    - Добавление полей загрузкой файлов оцифрованных полей,
    - Расчет примерной площади;
...
- Хранение данных: реляционная БД; долговременное хранение обращений и файлов. 
- **ИБ и доступ:**
    - Данные не общедоступны; роли (админ системы/админ хозяйства/пользователь); проверка прав на разделы. 
